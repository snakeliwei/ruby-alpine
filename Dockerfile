...
ENV BUILD_PACKAGES="build-base make git curl-dev nodejs gcc g++ bison gawk" \
    ...
    RUBY_PACKAGES="ruby ruby-dev ruby-io-console ruby-bundler ruby-nokogiri ruby-raindrops"
